...
<body style="background-color: #E5E5E5;">
      <main class="app-content"  style="width:500px;">
       ...
       <label><h2>Physio</h2></label>
                            <?php
          $q = $d->select("user_master","role_id=8");
          $i = 0;
        ...
        <div class="col-md-12" >
          ...
          <td style="padding-left:25px;"><h5><a href="view_physio1.php?id=<?php echo $result['u_id'];?>" style="text-decoration: none;" ><?php echo $result['u_fname'];?></a></h5></td>
        </tr>
